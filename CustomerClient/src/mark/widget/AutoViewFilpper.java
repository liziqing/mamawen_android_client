...
public class AutoViewFilpper extends FrameLayout {
	...
	public void startAutoPlay() {
		...
		new Timer().scheduleAtFixedRate(mTimerTask, SLOP_DELAY_TIME,
				SLOP_DELAY_TIME);
	}
	...
	private List<Bitmap> getBitmaps() {
		...
		bitmaps.add(BitmapFactory
				.decodeResource(getResources(), R.drawable.ad1));
		bitmaps.add(BitmapFactory
				.decodeResource(getResources(), R.drawable.ad2));
		bitmaps.add(BitmapFactory
				.decodeResource(getResources(), R.drawable.ad3));
